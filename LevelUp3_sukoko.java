import java.util.*;
public class LevelUp3_sukoko {
	
	//solve sudoko - Leet 37
	...
	/// permutation of a string- "ABC" --> "ABC","ACB","BCA","BAC","CAB","CBA"
    public static int perWithDupli(String str,String ans) {
    	if(str.length()==0) {
    ...
    public static int perWithDupliA(String str,String ans) {
    	if(str.length()==0) {
    		path.add(ans);
    		return 1;
    	}
    	...
    	for(int i=0;i<str.length();i++) {
    		char ch=str.charAt(i);
    		String roq=str.substring(0,i)+str.substring(i+1);
    		count += perWithDupliA(roq,ans+ch);
    	}
    	return count;
    }
    
  //doing the same with arraylist without duplicate
    public static ArrayList<String> pathWO= new ArrayList<>();
    public static int perWithDupliAWO(String str,String ans) {
    	if(str.length()==0) {
    		if(pathWO.contains(ans)) {
    	...
    	for(int i=0;i<str.length();i++) {
    		char ch=str.charAt(i);
    		String roq=str.substring(0,i)+str.substring(i+1);
    		count += perWithDupliAWO(roq,ans+ch);
    	}
    	return count;
    }
    
    //doing the same with arraylist without duplicate. array.contains takes a lot of time
    public static ArrayList<String> pathWO2= new ArrayList<>();
    public static int perWithDupliAWO2(String str,String ans) {
    	if(str.length()==0) {
    		if(pathWO2.contains(ans)) {    /// this checks for duplicasy.
    	...
    	for(int i=0;i<str.length();i++) {
    		char ch=str.charAt(i);
    		String roq=str.substring(0,i)+str.substring(i+1);
    		count += perWithDupliAWO2(roq,ans+ch);
    	}
    	return count;
    }
  ...
  //doing the same with arraylist 
    ...
    public static List<Integer> sans= new ArrayList<>();
    public static boolean[] vis;
    public static void permuteH(int[] nums,int count) {
